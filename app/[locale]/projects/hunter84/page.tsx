...
export default async function Hunter84Page() {
    const t = await getTranslations('Hunter84Page');

    return (
        <main className="min-h-screen bg-white text-gray-900">

            {/* Hero Section */}
            <section className="relative pt-24 pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-b from-[#fff5f5] to-white">
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-red-100 shadow-sm text-red-600 text-xs font-bold tracking-widest uppercase mb-12">
                        {t('premiumSub')}
                    </div>
                    <h1 className="text-6xl sm:text-8xl font-serif mb-12 text-metamask-purple leading-tight">
                        {t('titleStart')} <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-yellow-500">{t('titleEnd')}</span>
                    </h1>
                    <p className="text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed mb-16">
                        {t('description')}
                    </p>
                    <div className="flex flex-wrap justify-center gap-6">
                        <a href="https://hunter84.vercel.app" target="_blank" rel="noopener noreferrer" className="btn-primary px-10">
                            {t('exploreStudio')}
                        </a>
                ...
                <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-red-200/20 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2"></div>
                <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-yellow-100/30 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2"></div>
            </section>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        ...
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-br from-red-100 to-yellow-100 blur-[80px] opacity-20"></div>
                            <div className="relative bg-white/80 backdrop-blur-xl border border-white p-12 rounded-[50px] shadow-2xl">
                                <div className="aspect-square bg-[#fdfbff] rounded-[40px] flex items-center justify-center border border-red-50">
                                    <div className="text-center">
                                        <div className="w-20 h-20 bg-gradient-to-br from-red-500 to-yellow-400 rounded-3xl mx-auto mb-6 shadow-xl shadow-red-200"></div>
            ...
            <section className="py-24 bg-metamask-purple text-white relative overflow-hidden">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    ...
                    <div className="h-px w-24 bg-yellow-400 mx-auto"></div>
                </div>
            </section>

            {/* CTA section */}
            <section className="py-32 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto bg-gradient-to-br from-metamask-gray-50 to-white border border-red-50 rounded-[60px] p-12 md:p-24 text-center shadow-lg">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <a href="https://hunter84.vercel.app" target="_blank" rel="noopener noreferrer" className="btn-primary px-12 py-5 text-lg">
                            {t('enterStudio')}
                        </a>
