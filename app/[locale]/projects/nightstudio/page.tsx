...
export default async function NightStudioPage() {
    const t = await getTranslations('NightStudioPage');
            ...
            <section className="relative pt-24 pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-b from-[#f9f5ff] to-white">
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    ...
                    <h1 className="text-6xl sm:text-8xl font-serif mb-12 text-metamask-purple leading-tight">
                        {t('titleStart')} <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-green-500">{t('titleEnd')}</span>
                    </h1>
