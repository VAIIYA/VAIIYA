        ...
        <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-indigo-500/30">
            ...
            <main className="max-w-4xl mx-auto px-6 py-20">
                ...
                <div className="mt-20 pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <a href="mailto:privacy@vaiiya.com" className="text-xs text-gray-400 hover:text-white transition-colors uppercase tracking-widest">
                        Support: privacy@vaiiya.com
                    </a>
                </div>
            </main>

            <footer className="max-w-4xl mx-auto px-6 pb-20 text-[10px] text-gray-700 text-center uppercase tracking-tighter">
                © 2026 VAIIYA. Built on Integrity. Legal Presence: The Netherlands.
            </footer>
        </div>
    );
}
