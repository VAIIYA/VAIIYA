                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center">
                            ...
                            <a href="https://x.com/VaiiyaMedia" target="_blank" rel="noopener noreferrer" className="px-10 py-5 bg-white/5 text-white rounded-full font-bold uppercase tracking-widest text-sm border border-white/10 hover:bg-white/10 transition-all">
                                The Community
                            </a>
                        </div>
                    </div>
