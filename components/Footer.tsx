      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold text-gray-900">VAIIYA</span>
            </div>
              ...
              {socialLinks.map((social) => (
                <li key={social.name}>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-gray-600 hover:text-solana-purple transition-colors"
                  >
                    {social.icon}
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500">
            <span>Built on</span>
            <span className="font-semibold text-solana-purple">Solana</span>
